------------------------------------------------
-- DDL Statements for Table "CALL_CENTER_DB2LOAD"
------------------------------------------------
 

CREATE TABLE "CALL_CENTER_DB2LOAD"  (
...
-- DDL Statements for Primary Key on Table "CALL_CENTER_DB2LOAD"

ALTER TABLE "CALL_CENTER_DB2LOAD" 
	ADD PRIMARY KEY
		("CC_CALL_CENTER_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "CATALOG_PAGE_DB2LOAD"
------------------------------------------------
 

CREATE TABLE "CATALOG_PAGE_DB2LOAD"  (
...
-- DDL Statements for Primary Key on Table "CATALOG_PAGE_DB2LOAD"

ALTER TABLE "CATALOG_PAGE_DB2LOAD" 
	ADD PRIMARY KEY
		("CP_CATALOG_PAGE_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "CATALOG_RETURNS_DB2LOAD"
------------------------------------------------
 

CREATE TABLE "CATALOG_RETURNS_DB2LOAD"  (
...
-- DDL Statements for Primary Key on Table "CATALOG_RETURNS_DB2LOAD"

ALTER TABLE "CATALOG_RETURNS_DB2LOAD" 
	ADD PRIMARY KEY
		("CR_ITEM_SK",
		 "CR_ORDER_NUMBER")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "CATALOG_SALES_DB2LOAD"
------------------------------------------------
 

CREATE TABLE "CATALOG_SALES_DB2LOAD"  (
...
-- DDL Statements for Primary Key on Table "CATALOG_SALES_DB2LOAD"

ALTER TABLE "CATALOG_SALES_DB2LOAD" 
	ADD PRIMARY KEY
		("CS_ITEM_SK",
		 "CS_ORDER_NUMBER")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "CHAR_TEST_DB2LOAD"
------------------------------------------------
 

CREATE TABLE "CHAR_TEST_DB2LOAD"  (
...
------------------------------------------------
-- DDL Statements for Table "CUSTOMER_DB2LOAD"
------------------------------------------------
 

CREATE TABLE "CUSTOMER_DB2LOAD"  (
...
-- DDL Statements for Primary Key on Table "CUSTOMER_DB2LOAD"

ALTER TABLE "CUSTOMER_DB2LOAD" 
	ADD PRIMARY KEY
		("C_CUSTOMER_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "CUSTOMER_ADDRESS_DB2LOAD"
------------------------------------------------
 

CREATE TABLE "CUSTOMER_ADDRESS_DB2LOAD"  (
...
-- DDL Statements for Primary Key on Table "CUSTOMER_ADDRESS_DB2LOAD"

ALTER TABLE "CUSTOMER_ADDRESS_DB2LOAD" 
	ADD PRIMARY KEY
		("CA_ADDRESS_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "CUSTOMER_DEMOGRAPHICS_DB2LOAD"
------------------------------------------------
 

CREATE TABLE "CUSTOMER_DEMOGRAPHICS_DB2LOAD"  (
...
-- DDL Statements for Primary Key on Table "CUSTOMER_DEMOGRAPHICS_DB2LOAD"

ALTER TABLE "CUSTOMER_DEMOGRAPHICS_DB2LOAD" 
	ADD PRIMARY KEY
		("CD_DEMO_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "DATE_DIM_DB2LOAD"
------------------------------------------------
 

CREATE TABLE "DATE_DIM_DB2LOAD"  (
...
-- DDL Statements for Primary Key on Table "DATE_DIM_DB2LOAD"

ALTER TABLE "DATE_DIM_DB2LOAD" 
	ADD PRIMARY KEY
		("D_DATE_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "HOUSEHOLD_DEMOGRAPHICS_DB2LOAD"
------------------------------------------------
 

CREATE TABLE "HOUSEHOLD_DEMOGRAPHICS_DB2LOAD"  (
...
-- DDL Statements for Primary Key on Table "HOUSEHOLD_DEMOGRAPHICS_DB2LOAD"

ALTER TABLE "HOUSEHOLD_DEMOGRAPHICS_DB2LOAD" 
	ADD PRIMARY KEY
		("HD_DEMO_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "INCOME_BAND_DB2LOAD"
------------------------------------------------
 

CREATE TABLE "INCOME_BAND_DB2LOAD"  (
...
-- DDL Statements for Primary Key on Table "INCOME_BAND_DB2LOAD"

ALTER TABLE "INCOME_BAND_DB2LOAD" 
	ADD PRIMARY KEY
		("IB_INCOME_BAND_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "INVENTORY_DB2LOAD"
------------------------------------------------
 

CREATE TABLE "INVENTORY_DB2LOAD"  (
...
-- DDL Statements for Primary Key on Table "INVENTORY_DB2LOAD"

ALTER TABLE "INVENTORY_DB2LOAD" 
	ADD PRIMARY KEY
		("INV_DATE_SK",
		 "INV_ITEM_SK",
		 "INV_WAREHOUSE_SK")
...
------------------------------------------------
-- DDL Statements for Table "ITEM_DB2LOAD"
------------------------------------------------
 

CREATE TABLE "ITEM_DB2LOAD"  (
...
-- DDL Statements for Primary Key on Table "ITEM_DB2LOAD"

ALTER TABLE "ITEM_DB2LOAD" 
	ADD PRIMARY KEY
		("I_ITEM_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "PROMOTION_DB2LOAD"
------------------------------------------------
 

CREATE TABLE "PROMOTION_DB2LOAD"  (
...
-- DDL Statements for Primary Key on Table "PROMOTION_DB2LOAD"

ALTER TABLE "PROMOTION_DB2LOAD" 
	ADD PRIMARY KEY
		("P_PROMO_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "REASON_DB2LOAD"
------------------------------------------------
 

CREATE TABLE "REASON_DB2LOAD"  (
...
-- DDL Statements for Primary Key on Table "REASON_DB2LOAD"

ALTER TABLE "REASON_DB2LOAD" 
	ADD PRIMARY KEY
		("R_REASON_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "SHIP_MODE_DB2LOAD"
------------------------------------------------
 

CREATE TABLE "SHIP_MODE_DB2LOAD"  (
...
-- DDL Statements for Primary Key on Table "SHIP_MODE_DB2LOAD"

ALTER TABLE "SHIP_MODE_DB2LOAD" 
	ADD PRIMARY KEY
		("SM_SHIP_MODE_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "STORE_DB2LOAD"
------------------------------------------------
 

CREATE TABLE "STORE_DB2LOAD"  (
...
-- DDL Statements for Primary Key on Table "STORE_DB2LOAD"

ALTER TABLE "STORE_DB2LOAD" 
	ADD PRIMARY KEY
		("S_STORE_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "STORE_RETURNS_DB2LOAD"
------------------------------------------------
 

CREATE TABLE "STORE_RETURNS_DB2LOAD"  (
...
-- DDL Statements for Primary Key on Table "STORE_RETURNS_DB2LOAD"

ALTER TABLE "STORE_RETURNS_DB2LOAD" 
	ADD PRIMARY KEY
		("SR_ITEM_SK",
		 "SR_TICKET_NUMBER")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "STORE_SALES_DB2LOAD"
------------------------------------------------
 

CREATE TABLE "STORE_SALES_DB2LOAD"  (
...
-- DDL Statements for Primary Key on Table "STORE_SALES_DB2LOAD"

ALTER TABLE "STORE_SALES_DB2LOAD" 
	ADD PRIMARY KEY
		("SS_ITEM_SK",
		 "SS_TICKET_NUMBER")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "TIME_DIM_DB2LOAD"
------------------------------------------------
 

CREATE TABLE "TIME_DIM_DB2LOAD"  (
...
-- DDL Statements for Primary Key on Table "TIME_DIM_DB2LOAD"

ALTER TABLE "TIME_DIM_DB2LOAD" 
	ADD PRIMARY KEY
		("T_TIME_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "UTF8_TEST_DB2LOAD"
------------------------------------------------
 

CREATE TABLE "UTF8_TEST_DB2LOAD"  (
...
------------------------------------------------
-- DDL Statements for Table "WAREHOUSE_DB2LOAD"
------------------------------------------------
 

CREATE TABLE "WAREHOUSE_DB2LOAD"  (
...
-- DDL Statements for Primary Key on Table "WAREHOUSE_DB2LOAD"

ALTER TABLE "WAREHOUSE_DB2LOAD" 
	ADD PRIMARY KEY
		("W_WAREHOUSE_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "WEB_PAGE_DB2LOAD"
------------------------------------------------
 

CREATE TABLE "WEB_PAGE_DB2LOAD"  (
...
-- DDL Statements for Primary Key on Table "WEB_PAGE_DB2LOAD"

ALTER TABLE "WEB_PAGE_DB2LOAD" 
	ADD PRIMARY KEY
		("WP_WEB_PAGE_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "WEB_RETURNS_DB2LOAD"
------------------------------------------------
 

CREATE TABLE "WEB_RETURNS_DB2LOAD"  (
...
-- DDL Statements for Primary Key on Table "WEB_RETURNS_DB2LOAD"

ALTER TABLE "WEB_RETURNS_DB2LOAD" 
	ADD PRIMARY KEY
		("WR_ITEM_SK",
		 "WR_ORDER_NUMBER")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "WEB_SALES_DB2LOAD"
------------------------------------------------
 

CREATE TABLE "WEB_SALES_DB2LOAD"  (
...
-- DDL Statements for Primary Key on Table "WEB_SALES_DB2LOAD"

ALTER TABLE "WEB_SALES_DB2LOAD" 
	ADD PRIMARY KEY
		("WS_ITEM_SK",
		 "WS_ORDER_NUMBER")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "WEB_SITE_DB2LOAD"
------------------------------------------------
 

CREATE TABLE "WEB_SITE_DB2LOAD"  (
...
-- DDL Statements for Primary Key on Table "WEB_SITE_DB2LOAD"

ALTER TABLE "WEB_SITE_DB2LOAD" 
	ADD PRIMARY KEY
		("WEB_SITE_SK")
	NOT ENFORCED;
