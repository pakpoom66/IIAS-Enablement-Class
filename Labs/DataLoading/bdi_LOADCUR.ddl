...
-- Timestamp: Thu Oct 26 09:30:51 2017
-- Database Name: BLUDB          
-- Database Manager Version: DB2/LINUXPPC64LE Version 11.1.9.0
...
CREATE TABLE "TEAM00  "."CALL_CENTER_LOADCUR"  (
...
CREATE TABLE "TEAM00  "."CATALOG_PAGE_LOADCUR"  (
...
CREATE TABLE "TEAM00  "."CATALOG_RETURNS_LOADCUR"  (
...
CREATE TABLE "TEAM00  "."CUSTOMER_ADDRESS_LOADCUR"  (
		  ...
		  "CA_CITY" VARCHAR(60 OCTETS) NOT NULL WITH DEFAULT ' ' , 
		  "CA_COUNTY" VARCHAR(30 OCTETS) NOT NULL WITH DEFAULT ' ' , 
		  "CA_STATE" CHAR(2 OCTETS) NOT NULL WITH DEFAULT ' ' , 
		  "CA_ZIP" CHAR(10 OCTETS) NOT NULL WITH DEFAULT ' ' , 
		  "CA_COUNTRY" VARCHAR(20 OCTETS) NOT NULL WITH DEFAULT ' ' , 
...
CREATE TABLE "TEAM00  "."CUSTOMER_DEMOGRAPHICS_LOADCUR"  (
...
CREATE TABLE "TEAM00  "."DATE_DIM_LOADCUR"  (
...
CREATE TABLE "TEAM00  "."HOUSEHOLD_DEMOGRAPHICS_LOADCUR"  (
...
CREATE TABLE "TEAM00  "."INCOME_BAND_LOADCUR"  (
...
CREATE TABLE "TEAM00  "."INVENTORY_LOADCUR"  (
...
CREATE TABLE "TEAM00  "."ITEM_LOADCUR"  (
		  "I_ITEM_SK" BIGINT NOT NULL , 
		  "I_ITEM_ID" CHAR(16 OCTETS) NOT NULL WITH DEFAULT ' ' , 
		  "I_REC_START_DATE" DATE , 
		  "I_REC_END_DATE" DATE , 
		  "I_ITEM_DESC" VARCHAR(200 OCTETS) NOT NULL WITH DEFAULT ' ' , 
		  "I_CURRENT_PRICE" DECIMAL(7,2) , 
		  "I_WHOLESALE_COST" DECIMAL(7,2) , 
		  "I_BRAND_ID" BIGINT NOT NULL , 
		  "I_BRAND" VARCHAR(50 OCTETS) NOT NULL WITH DEFAULT ' ' , 
		  "I_CLASS_ID" BIGINT NOT NULL , 
		  "I_CLASS" VARCHAR(50 OCTETS) NOT NULL WITH DEFAULT ' ' , 
		  "I_CATEGORY_ID" BIGINT NOT NULL , 
		  "I_CATEGORY" VARCHAR(50 OCTETS) NOT NULL WITH DEFAULT ' ' , 
		  "I_MANUFACT_ID" BIGINT NOT NULL , 
		  "I_MANUFACT" CHAR(50 OCTETS) NOT NULL WITH DEFAULT ' ' , 
		  ...
		  "I_PRODUCT_NAME" CHAR(50 OCTETS) NOT NULL WITH DEFAULT ' ' )   
...
CREATE TABLE "TEAM00  "."PROMOTION_LOADCUR"  (
...
CREATE TABLE "TEAM00  "."REASON_LOADCUR"  (
...
CREATE TABLE "TEAM00  "."SHIP_MODE_LOADCUR"  (
...
CREATE TABLE "TEAM00  "."STORE_LOADCUR"  (
		  "S_STORE_SK" BIGINT NOT NULL , 
		  "S_STORE_ID" CHAR(16 OCTETS) NOT NULL WITH DEFAULT ' ' , 
		  "S_REC_START_DATE" DATE , 
		  "S_REC_END_DATE" DATE , 
		  "S_CLOSED_DATE_SK" BIGINT , 
		  "S_STORE_NAME" VARCHAR(50 OCTETS) NOT NULL WITH DEFAULT ' ' , 
		  "S_NUMBER_EMPLOYEES" BIGINT , 
		  "S_FLOOR_SPACE" BIGINT , 
		  "S_HOURS" CHAR(20 OCTETS) , 
		  "S_MANAGER" VARCHAR(40 OCTETS) NOT NULL WITH DEFAULT ' ' , 
		  "S_MARKET_ID" BIGINT NOT NULL , 
		  "S_GEOGRAPHY_CLASS" VARCHAR(100 OCTETS) NOT NULL WITH DEFAULT ' ' , 
		  "S_MARKET_DESC" VARCHAR(100 OCTETS) NOT NULL WITH DEFAULT ' ' , 
		  "S_MARKET_MANAGER" VARCHAR(40 OCTETS) NOT NULL WITH DEFAULT ' ' , 
		  "S_DIVISION_ID" BIGINT NOT NULL , 
		  "S_DIVISION_NAME" VARCHAR(50 OCTETS) NOT NULL WITH DEFAULT ' ' , 
		  "S_COMPANY_ID" BIGINT NOT NULL , 
		  "S_COMPANY_NAME" VARCHAR(50 OCTETS) NOT NULL WITH DEFAULT ' ' , 
		  ...
		  "S_CITY" VARCHAR(60 OCTETS) NOT NULL WITH DEFAULT ' ' , 
		  "S_COUNTY" VARCHAR(30 OCTETS) NOT NULL WITH DEFAULT ' ' , 
		  "S_STATE" CHAR(2 OCTETS) NOT NULL WITH DEFAULT ' ' , 
		  "S_ZIP" CHAR(10 OCTETS) NOT NULL WITH DEFAULT ' ' , 
		  "S_COUNTRY" VARCHAR(20 OCTETS) NOT NULL WITH DEFAULT ' ' , 
...
CREATE TABLE "TEAM00  "."STORE_RETURNS_LOADCUR"  (
...
CREATE TABLE "TEAM00  "."STORE_SALES_LOADCUR"  (
...
CREATE TABLE "TEAM00  "."TIME_DIM_LOADCUR"  (
		  ...
		  "T_AM_PM" CHAR(2 OCTETS) NOT NULL WITH DEFAULT ' ' , 
		  "T_SHIFT" CHAR(20 OCTETS) NOT NULL WITH DEFAULT ' ' , 
		  "T_SUB_SHIFT" CHAR(20 OCTETS) NOT NULL WITH DEFAULT ' ' , 
		  "T_MEAL_TIME" CHAR(20 OCTETS) NOT NULL WITH DEFAULT ' ' )   
...
CREATE TABLE "TEAM00  "."UTF8_TEST_LOADCUR"  (
...
CREATE TABLE "TEAM00  "."WAREHOUSE_LOADCUR"  (
...
CREATE TABLE "TEAM00  "."WEB_PAGE_LOADCUR"  (
...
CREATE TABLE "TEAM00  "."WEB_RETURNS_LOADCUR"  (
...
CREATE TABLE "TEAM00  "."WEB_SALES_LOADCUR"  (
...
CREATE TABLE "TEAM00  "."WEB_SITE_LOADCUR"  (
...
CREATE TABLE "TEAM00  "."CUSTOMER_LOADCUR"  (
...
CREATE TABLE "TEAM00  "."CATALOG_SALES_LOADCUR"  (
...
------------------------------------------------
-- DDL Statements for Table "TEAM00  "."CUSTOMER_LOADCUR"
------------------------------------------------
 

CREATE TABLE "TEAM00  "."CUSTOMER_LOAD_LOADCUR"  (
		  "C_CUSTOMER_SK" BIGINT NOT NULL , 
		  "C_CUSTOMER_ID" CHAR(16 OCTETS) NOT NULL WITH DEFAULT ' ' , 
		  "C_CURRENT_CDEMO_SK" BIGINT , 
		  "C_CURRENT_HDEMO_SK" BIGINT , 
...
CREATE TABLE "TEAM00  "."SALES_FACT_LOADCUR"  (
		 ...
		 DISTRIBUTE BY HASH("CUSTOMER_CODE")   
		   IN "TEAM08_TSFACT"  
		 ORGANIZE BY COLUMN; 
...
CREATE TABLE "TEAM00  "."CHAR_TEST_LOADCUR"  (
