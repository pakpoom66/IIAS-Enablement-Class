------------------------------------------------
-- DDL Statements for Table "CALL_CENTER_FEDLOAD"
------------------------------------------------
 

CREATE TABLE "CALL_CENTER_FEDLOAD"  (
...
-- DDL Statements for Primary Key on Table "CALL_CENTER_FEDLOAD"

ALTER TABLE "CALL_CENTER_FEDLOAD" 
	ADD PRIMARY KEY
		("CC_CALL_CENTER_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "CATALOG_PAGE_FEDLOAD"
------------------------------------------------
 

CREATE TABLE "CATALOG_PAGE_FEDLOAD"  (
...
-- DDL Statements for Primary Key on Table "CATALOG_PAGE_FEDLOAD"

ALTER TABLE "CATALOG_PAGE_FEDLOAD" 
	ADD PRIMARY KEY
		("CP_CATALOG_PAGE_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "CATALOG_RETURNS_FEDLOAD"
------------------------------------------------
 

CREATE TABLE "CATALOG_RETURNS_FEDLOAD"  (
...
-- DDL Statements for Primary Key on Table "CATALOG_RETURNS_FEDLOAD"

ALTER TABLE "CATALOG_RETURNS_FEDLOAD" 
	ADD PRIMARY KEY
		("CR_ITEM_SK",
		 "CR_ORDER_NUMBER")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "CATALOG_SALES_FEDLOAD"
------------------------------------------------
 

CREATE TABLE "CATALOG_SALES_FEDLOAD"  (
...
-- DDL Statements for Primary Key on Table "CATALOG_SALES_FEDLOAD"

ALTER TABLE "CATALOG_SALES_FEDLOAD" 
	ADD PRIMARY KEY
		("CS_ITEM_SK",
		 "CS_ORDER_NUMBER")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "CHAR_TEST_FEDLOAD"
------------------------------------------------
 

CREATE TABLE "CHAR_TEST_FEDLOAD"  (
...
------------------------------------------------
-- DDL Statements for Table "CUSTOMER_FEDLOAD"
------------------------------------------------
 

CREATE TABLE "CUSTOMER_FEDLOAD"  (
...
-- DDL Statements for Primary Key on Table "CUSTOMER_FEDLOAD"

ALTER TABLE "CUSTOMER_FEDLOAD" 
	ADD PRIMARY KEY
		("C_CUSTOMER_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "CUSTOMER_ADDRESS_FEDLOAD"
------------------------------------------------
 

CREATE TABLE "CUSTOMER_ADDRESS_FEDLOAD"  (
...
-- DDL Statements for Primary Key on Table "CUSTOMER_ADDRESS_FEDLOAD"

ALTER TABLE "CUSTOMER_ADDRESS_FEDLOAD" 
	ADD PRIMARY KEY
		("CA_ADDRESS_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "CUSTOMER_DEMOGRAPHICS_FEDLOAD"
------------------------------------------------
 

CREATE TABLE "CUSTOMER_DEMOGRAPHICS_FEDLOAD"  (
...
-- DDL Statements for Primary Key on Table "CUSTOMER_DEMOGRAPHICS_FEDLOAD"

ALTER TABLE "CUSTOMER_DEMOGRAPHICS_FEDLOAD" 
	ADD PRIMARY KEY
		("CD_DEMO_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "DATE_DIM_FEDLOAD"
------------------------------------------------
 

CREATE TABLE "DATE_DIM_FEDLOAD"  (
...
-- DDL Statements for Primary Key on Table "DATE_DIM_FEDLOAD"

ALTER TABLE "DATE_DIM_FEDLOAD" 
	ADD PRIMARY KEY
		("D_DATE_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "HOUSEHOLD_DEMOGRAPHICS_FEDLOAD"
------------------------------------------------
 

CREATE TABLE "HOUSEHOLD_DEMOGRAPHICS_FEDLOAD"  (
...
-- DDL Statements for Primary Key on Table "HOUSEHOLD_DEMOGRAPHICS_FEDLOAD"

ALTER TABLE "HOUSEHOLD_DEMOGRAPHICS_FEDLOAD" 
	ADD PRIMARY KEY
		("HD_DEMO_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "INCOME_BAND_FEDLOAD"
------------------------------------------------
 

CREATE TABLE "INCOME_BAND_FEDLOAD"  (
...
-- DDL Statements for Primary Key on Table "INCOME_BAND_FEDLOAD"

ALTER TABLE "INCOME_BAND_FEDLOAD" 
	ADD PRIMARY KEY
		("IB_INCOME_BAND_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "INVENTORY_FEDLOAD"
------------------------------------------------
 

CREATE TABLE "INVENTORY_FEDLOAD"  (
...
-- DDL Statements for Primary Key on Table "INVENTORY_FEDLOAD"

ALTER TABLE "INVENTORY_FEDLOAD" 
	ADD PRIMARY KEY
		("INV_DATE_SK",
		 "INV_ITEM_SK",
		 "INV_WAREHOUSE_SK")
...
------------------------------------------------
-- DDL Statements for Table "ITEM_FEDLOAD"
------------------------------------------------
 

CREATE TABLE "ITEM_FEDLOAD"  (
...
-- DDL Statements for Primary Key on Table "ITEM_FEDLOAD"

ALTER TABLE "ITEM_FEDLOAD" 
	ADD PRIMARY KEY
		("I_ITEM_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "PROMOTION_FEDLOAD"
------------------------------------------------
 

CREATE TABLE "PROMOTION_FEDLOAD"  (
...
-- DDL Statements for Primary Key on Table "PROMOTION_FEDLOAD"

ALTER TABLE "PROMOTION_FEDLOAD" 
	ADD PRIMARY KEY
		("P_PROMO_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "REASON_FEDLOAD"
------------------------------------------------
 

CREATE TABLE "REASON_FEDLOAD"  (
...
-- DDL Statements for Primary Key on Table "REASON_FEDLOAD"

ALTER TABLE "REASON_FEDLOAD" 
	ADD PRIMARY KEY
		("R_REASON_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "SHIP_MODE_FEDLOAD"
------------------------------------------------
 

CREATE TABLE "SHIP_MODE_FEDLOAD"  (
...
-- DDL Statements for Primary Key on Table "SHIP_MODE_FEDLOAD"

ALTER TABLE "SHIP_MODE_FEDLOAD" 
	ADD PRIMARY KEY
		("SM_SHIP_MODE_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "STORE_FEDLOAD"
------------------------------------------------
 

CREATE TABLE "STORE_FEDLOAD"  (
...
-- DDL Statements for Primary Key on Table "STORE_FEDLOAD"

ALTER TABLE "STORE_FEDLOAD" 
	ADD PRIMARY KEY
		("S_STORE_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "STORE_RETURNS_FEDLOAD"
------------------------------------------------
 

CREATE TABLE "STORE_RETURNS_FEDLOAD"  (
...
-- DDL Statements for Primary Key on Table "STORE_RETURNS_FEDLOAD"

ALTER TABLE "STORE_RETURNS_FEDLOAD" 
	ADD PRIMARY KEY
		("SR_ITEM_SK",
		 "SR_TICKET_NUMBER")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "STORE_SALES_FEDLOAD"
------------------------------------------------
 

CREATE TABLE "STORE_SALES_FEDLOAD"  (
...
-- DDL Statements for Primary Key on Table "STORE_SALES_FEDLOAD"

ALTER TABLE "STORE_SALES_FEDLOAD" 
	ADD PRIMARY KEY
		("SS_ITEM_SK",
		 "SS_TICKET_NUMBER")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "TIME_DIM_FEDLOAD"
------------------------------------------------
 

CREATE TABLE "TIME_DIM_FEDLOAD"  (
...
-- DDL Statements for Primary Key on Table "TIME_DIM_FEDLOAD"

ALTER TABLE "TIME_DIM_FEDLOAD" 
	ADD PRIMARY KEY
		("T_TIME_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "UTF8_TEST_FEDLOAD"
------------------------------------------------
 

CREATE TABLE "UTF8_TEST_FEDLOAD"  (
...
------------------------------------------------
-- DDL Statements for Table "WAREHOUSE_FEDLOAD"
------------------------------------------------
 

CREATE TABLE "WAREHOUSE_FEDLOAD"  (
...
-- DDL Statements for Primary Key on Table "WAREHOUSE_FEDLOAD"

ALTER TABLE "WAREHOUSE_FEDLOAD" 
	ADD PRIMARY KEY
		("W_WAREHOUSE_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "WEB_PAGE_FEDLOAD"
------------------------------------------------
 

CREATE TABLE "WEB_PAGE_FEDLOAD"  (
...
-- DDL Statements for Primary Key on Table "WEB_PAGE_FEDLOAD"

ALTER TABLE "WEB_PAGE_FEDLOAD" 
	ADD PRIMARY KEY
		("WP_WEB_PAGE_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "WEB_RETURNS_FEDLOAD"
------------------------------------------------
 

CREATE TABLE "WEB_RETURNS_FEDLOAD"  (
...
-- DDL Statements for Primary Key on Table "WEB_RETURNS_FEDLOAD"

ALTER TABLE "WEB_RETURNS_FEDLOAD" 
	ADD PRIMARY KEY
		("WR_ITEM_SK",
		 "WR_ORDER_NUMBER")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "WEB_SALES_FEDLOAD"
------------------------------------------------
 

CREATE TABLE "WEB_SALES_FEDLOAD"  (
...
-- DDL Statements for Primary Key on Table "WEB_SALES_FEDLOAD"

ALTER TABLE "WEB_SALES_FEDLOAD" 
	ADD PRIMARY KEY
		("WS_ITEM_SK",
		 "WS_ORDER_NUMBER")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "WEB_SITE_FEDLOAD"
------------------------------------------------
 

CREATE TABLE "WEB_SITE_FEDLOAD"  (
...
-- DDL Statements for Primary Key on Table "WEB_SITE_FEDLOAD"

ALTER TABLE "WEB_SITE_FEDLOAD" 
	ADD PRIMARY KEY
		("WEB_SITE_SK")
	NOT ENFORCED;
