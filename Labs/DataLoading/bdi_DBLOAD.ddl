------------------------------------------------
-- DDL Statements for Table "CALL_CENTER_DBLOAD"
------------------------------------------------
 

CREATE TABLE "CALL_CENTER_DBLOAD"  (
...
-- DDL Statements for Primary Key on Table "CALL_CENTER_DBLOAD"

ALTER TABLE "CALL_CENTER_DBLOAD" 
	ADD PRIMARY KEY
		("CC_CALL_CENTER_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "CATALOG_PAGE_DBLOAD"
------------------------------------------------
 

CREATE TABLE "CATALOG_PAGE_DBLOAD"  (
...
-- DDL Statements for Primary Key on Table "CATALOG_PAGE_DBLOAD"

ALTER TABLE "CATALOG_PAGE_DBLOAD" 
	ADD PRIMARY KEY
		("CP_CATALOG_PAGE_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "CATALOG_RETURNS_DBLOAD"
------------------------------------------------
 

CREATE TABLE "CATALOG_RETURNS_DBLOAD"  (
...
-- DDL Statements for Primary Key on Table "CATALOG_RETURNS_DBLOAD"

ALTER TABLE "CATALOG_RETURNS_DBLOAD" 
	ADD PRIMARY KEY
		("CR_ITEM_SK",
		 "CR_ORDER_NUMBER")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "CATALOG_SALES_DBLOAD"
------------------------------------------------
 

CREATE TABLE "CATALOG_SALES_DBLOAD"  (
...
-- DDL Statements for Primary Key on Table "CATALOG_SALES_DBLOAD"

ALTER TABLE "CATALOG_SALES_DBLOAD" 
	ADD PRIMARY KEY
		("CS_ITEM_SK",
		 "CS_ORDER_NUMBER")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "CHAR_TEST_DBLOAD"
------------------------------------------------
 

CREATE TABLE "CHAR_TEST_DBLOAD"  (
...
------------------------------------------------
-- DDL Statements for Table "CUSTOMER_DBLOAD"
------------------------------------------------
 

CREATE TABLE "CUSTOMER_DBLOAD"  (
...
-- DDL Statements for Primary Key on Table "CUSTOMER_DBLOAD"

ALTER TABLE "CUSTOMER_DBLOAD" 
	ADD PRIMARY KEY
		("C_CUSTOMER_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "CUSTOMER_ADDRESS_DBLOAD"
------------------------------------------------
 

CREATE TABLE "CUSTOMER_ADDRESS_DBLOAD"  (
...
-- DDL Statements for Primary Key on Table "CUSTOMER_ADDRESS_DBLOAD"

ALTER TABLE "CUSTOMER_ADDRESS_DBLOAD" 
	ADD PRIMARY KEY
		("CA_ADDRESS_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "CUSTOMER_DEMOGRAPHICS_DBLOAD"
------------------------------------------------
 

CREATE TABLE "CUSTOMER_DEMOGRAPHICS_DBLOAD"  (
...
-- DDL Statements for Primary Key on Table "CUSTOMER_DEMOGRAPHICS_DBLOAD"

ALTER TABLE "CUSTOMER_DEMOGRAPHICS_DBLOAD" 
	ADD PRIMARY KEY
		("CD_DEMO_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "DATE_DIM_DBLOAD"
------------------------------------------------
 

CREATE TABLE "DATE_DIM_DBLOAD"  (
...
-- DDL Statements for Primary Key on Table "DATE_DIM_DBLOAD"

ALTER TABLE "DATE_DIM_DBLOAD" 
	ADD PRIMARY KEY
		("D_DATE_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "HOUSEHOLD_DEMOGRAPHICS_DBLOAD"
------------------------------------------------
 

CREATE TABLE "HOUSEHOLD_DEMOGRAPHICS_DBLOAD"  (
...
-- DDL Statements for Primary Key on Table "HOUSEHOLD_DEMOGRAPHICS_DBLOAD"

ALTER TABLE "HOUSEHOLD_DEMOGRAPHICS_DBLOAD" 
	ADD PRIMARY KEY
		("HD_DEMO_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "INCOME_BAND_DBLOAD"
------------------------------------------------
 

CREATE TABLE "INCOME_BAND_DBLOAD"  (
...
-- DDL Statements for Primary Key on Table "INCOME_BAND_DBLOAD"

ALTER TABLE "INCOME_BAND_DBLOAD" 
	ADD PRIMARY KEY
		("IB_INCOME_BAND_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "INVENTORY_DBLOAD"
------------------------------------------------
 

CREATE TABLE "INVENTORY_DBLOAD"  (
...
-- DDL Statements for Primary Key on Table "INVENTORY_DBLOAD"

ALTER TABLE "INVENTORY_DBLOAD" 
	ADD PRIMARY KEY
		("INV_DATE_SK",
		 "INV_ITEM_SK",
		 "INV_WAREHOUSE_SK")
...
------------------------------------------------
-- DDL Statements for Table "ITEM_DBLOAD"
------------------------------------------------
 

CREATE TABLE "ITEM_DBLOAD"  (
...
-- DDL Statements for Primary Key on Table "ITEM_DBLOAD"

ALTER TABLE "ITEM_DBLOAD" 
	ADD PRIMARY KEY
		("I_ITEM_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "PROMOTION_DBLOAD"
------------------------------------------------
 

CREATE TABLE "PROMOTION_DBLOAD"  (
...
-- DDL Statements for Primary Key on Table "PROMOTION_DBLOAD"

ALTER TABLE "PROMOTION_DBLOAD" 
	ADD PRIMARY KEY
		("P_PROMO_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "REASON_DBLOAD"
------------------------------------------------
 

CREATE TABLE "REASON_DBLOAD"  (
...
-- DDL Statements for Primary Key on Table "REASON_DBLOAD"

ALTER TABLE "REASON_DBLOAD" 
	ADD PRIMARY KEY
		("R_REASON_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "SHIP_MODE_DBLOAD"
------------------------------------------------
 

CREATE TABLE "SHIP_MODE_DBLOAD"  (
...
-- DDL Statements for Primary Key on Table "SHIP_MODE_DBLOAD"

ALTER TABLE "SHIP_MODE_DBLOAD" 
	ADD PRIMARY KEY
		("SM_SHIP_MODE_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "STORE_DBLOAD"
------------------------------------------------
 

CREATE TABLE "STORE_DBLOAD"  (
...
-- DDL Statements for Primary Key on Table "STORE_DBLOAD"

ALTER TABLE "STORE_DBLOAD" 
	ADD PRIMARY KEY
		("S_STORE_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "STORE_RETURNS_DBLOAD"
------------------------------------------------
 

CREATE TABLE "STORE_RETURNS_DBLOAD"  (
...
-- DDL Statements for Primary Key on Table "STORE_RETURNS_DBLOAD"

ALTER TABLE "STORE_RETURNS_DBLOAD" 
	ADD PRIMARY KEY
		("SR_ITEM_SK",
		 "SR_TICKET_NUMBER")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "STORE_SALES_DBLOAD"
------------------------------------------------
 

CREATE TABLE "STORE_SALES_DBLOAD"  (
...
-- DDL Statements for Primary Key on Table "STORE_SALES_DBLOAD"

ALTER TABLE "STORE_SALES_DBLOAD" 
	ADD PRIMARY KEY
		("SS_ITEM_SK",
		 "SS_TICKET_NUMBER")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "TIME_DIM_DBLOAD"
------------------------------------------------
 

CREATE TABLE "TIME_DIM_DBLOAD"  (
...
-- DDL Statements for Primary Key on Table "TIME_DIM_DBLOAD"

ALTER TABLE "TIME_DIM_DBLOAD" 
	ADD PRIMARY KEY
		("T_TIME_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "UTF8_TEST_DBLOAD"
------------------------------------------------
 

CREATE TABLE "UTF8_TEST_DBLOAD"  (
...
------------------------------------------------
-- DDL Statements for Table "WAREHOUSE_DBLOAD"
------------------------------------------------
 

CREATE TABLE "WAREHOUSE_DBLOAD"  (
...
-- DDL Statements for Primary Key on Table "WAREHOUSE_DBLOAD"

ALTER TABLE "WAREHOUSE_DBLOAD" 
	ADD PRIMARY KEY
		("W_WAREHOUSE_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "WEB_PAGE_DBLOAD"
------------------------------------------------
 

CREATE TABLE "WEB_PAGE_DBLOAD"  (
...
-- DDL Statements for Primary Key on Table "WEB_PAGE_DBLOAD"

ALTER TABLE "WEB_PAGE_DBLOAD" 
	ADD PRIMARY KEY
		("WP_WEB_PAGE_SK")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "WEB_RETURNS_DBLOAD"
------------------------------------------------
 

CREATE TABLE "WEB_RETURNS_DBLOAD"  (
...
-- DDL Statements for Primary Key on Table "WEB_RETURNS_DBLOAD"

ALTER TABLE "WEB_RETURNS_DBLOAD" 
	ADD PRIMARY KEY
		("WR_ITEM_SK",
		 "WR_ORDER_NUMBER")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "WEB_SALES_DBLOAD"
------------------------------------------------
 

CREATE TABLE "WEB_SALES_DBLOAD"  (
...
-- DDL Statements for Primary Key on Table "WEB_SALES_DBLOAD"

ALTER TABLE "WEB_SALES_DBLOAD" 
	ADD PRIMARY KEY
		("WS_ITEM_SK",
		 "WS_ORDER_NUMBER")
	NOT ENFORCED;
...
------------------------------------------------
-- DDL Statements for Table "WEB_SITE_DBLOAD"
------------------------------------------------
 

CREATE TABLE "WEB_SITE_DBLOAD"  (
...
-- DDL Statements for Primary Key on Table "WEB_SITE_DBLOAD"

ALTER TABLE "WEB_SITE_DBLOAD" 
	ADD PRIMARY KEY
		("WEB_SITE_SK")
	NOT ENFORCED;
