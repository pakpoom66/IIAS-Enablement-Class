...
1. Start the Harmony Profiler.  
  1. Double click the ***db_harmony_profiler.sh*** desktop launcher.  This will start Harmony Profiler.
  	 ![Harmony Profiler](MigrationTooling/images/HarmonyLaunch.png)
1. Check the compatibility between Netezza DDL extracted and and what is expected in Db2 Warehouse.  
  ...
  1. Click on ***Check Compatibility***
   ![Harmony Profiler](MigrationTooling/images/CheckCompat.png )
  ...
  ![review SQL](MigrationTooling/images/ReadContertedSQL.png)
  ...
  1. `./db_harmony_profiler.sh -help |more` to find the options.
    ![Harmony Profiler Command Line](MigrationTooling/images/HpConsoleHelp.png)
  ...
  1. From the browser, click the ***Db2 Warehouse***
    ![Launch DB2 WH console](MigrationTooling/images/Db2whConsoleLaunch.png)
  ...
  ![results SQL](MigrationTooling/images/logresults.png)
...
1. Login into the Db2 Warehouse local container on your vm.
  ...
  ![bluadmin](MigrationTooling/images/Bluadmin_login.png)

  1. From the command prompt type `db_migrate -h`.
   ![Harmony Profiler](MigrationTooling/images/db_migrate.png)
  ...
  1.  For this lab, you need to run a few commands since we are running a none standard port and db_migrate is not properly working with `-sport` argument.  None fo this would be necessary if we were using an IIAS system.  So bare with this hack.
    ...
    ![db_migrate output](MigrationTooling/images/db_migrateLog.png)
...
[NZ Table counts](MigrationTooling/images/BDI_rowcounts.md )

Compare the table sizes between the Netezza and IIAS.  On IIAS use the `db_size` script to get tables size information.
[NZ Table sizes](MigrationTooling/images/BDI_DBSize.md)

[Sample migration script](MigrationTooling/images/migrate.sh)
...
Single table migration [migrate-table script](MigrationTooling/images/migrate-table.sh) example.

If you want a peak at the answers, try this page. [Answer sheet](MigrationTooling/images/Answers.md )
...
* [Netezza Source DML](MigrationTooling/images/NZQueries/nzbdinsights.sql)
