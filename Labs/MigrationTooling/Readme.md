...
The following details the Migration Lab.  This lab is a simulation of a simple  IBM Integrated Analytics System (IIAS) Migration POC pulling data and queries from an existing Netezza system (see [Lab Narrative](Labs/MigrationTooling/LabNarrative.md)).  
...
Read the [Lab Narrative](Labs/MigrationTooling/LabNarrative.md) to understand the background of the Lab/POC.
...
1. Start the Harmony Profiler.  
  1. Double click the ***db_harmony_profiler.sh*** desktop launcher.  This will start Harmony Profiler.
  	 ![Harmony Profiler](Labs/MigrationTooling/images/HarmonyLaunch.png)
1. Check the compatibility between Netezza DDL extracted and and what is expected in Db2 Warehouse.  
  ...
  1. Click on ***Check Compatibility***
   ![Harmony Profiler](Labs/MigrationTooling/images/CheckCompat.png )
  ...
  ![result](Labs/MigrationTooling/images/LaunchReport.png)
  1. The HTML report will be launched showing the ***Summary*** page.
  ![summary](Labs/MigrationTooling/images/Summary.png)
  1. Switch to the next tab that shows ***Automatically conversion available*** tab.  Expand the `+` sign to see more details.
  ![auto convert](Labs/MigrationTooling/images/autoConvert.png)
  1. Switch to the ***Manual conversion needed*** tab.
  ![manual convert](Labs/MigrationTooling/images/manualConvert.png)
  1. Switch to the ***Unrecognized Syntax*** tab
    ![unrecognized syntax](Labs/MigrationTooling/images/unrecognizedSyntax.png)
  1. Switch to the ***Statistics*** tab.
   ![summary](Labs/MigrationTooling/images/statistics.png)

  ### Convert the ddl
  Since reviewing the evaluation and all seems pretty clean, go ahead back to the tool.   
  1. Click on ***Convert SQL***
  ![convert SQL](Labs/MigrationTooling/images/ConvertCode.png)
  1. Double Click result to review converted ddl.
  ![review SQL](Labs/MigrationTooling/images/launchreportConvert.png)
  ...
  ![review SQL](Labs/MigrationTooling/images/ReadContertedSQL.png)
  ...
  1. `./db_harmony_profiler.sh -help |more` to find the options.
    ![Harmony Profiler Command Line](Labs/MigrationTooling/images/HpConsoleHelp.png)
  ...
  1. From the browser, click the ***Db2 Warehouse***
    ![Launch DB2 WH console](Labs/MigrationTooling/images/Db2whConsoleLaunch.png)
  ...
  ![run SQL](Labs/MigrationTooling/images/runSql.png)
  1. Click ***Script*** then ***Open from client***
  ![load SQL](Labs/MigrationTooling/images/OpenClient.png)
  1. Select ***Browse*** then select `~/nz/tmp/nz/gather_nz_info/extracted.BDI_converted.cleaned.sql` file and click ***Open***.
  ![open SQL](Labs/MigrationTooling/images/loadsql.png)
  1. Review the imported SQL, then click ***Run All***
  ![Run SQL](Labs/MigrationTooling/images/runall.png)
  1. Review the results.  Notice that there were no failures.  
  ![Run SQL](Labs/MigrationTooling/images/success.png)
  ...
  ![results SQL](Labs/MigrationTooling/images/logresults.png)
...
1. Login into the Db2 Warehouse local container on your vm.
  ...
  ![bluadmin](Labs/MigrationTooling/images/Bluadmin_login.png)

  1. From the command prompt type `db_migrate -h`.
   ![Harmony Profiler](Labs/MigrationTooling/images/db_migrate.png)
  ...
  1.  For this lab, you need to run a few commands since we are running a none standard port and db_migrate is not properly working with `-sport` argument.  None fo this would be necessary if we were using an IIAS system.  So bare with this hack.
    ...
    ![db_migrate output](Labs/MigrationTooling/images/db_migrateLog.png)
...
[NZ Table counts](Labs/MigrationTooling/images/BDI_rowcounts.md )

Compare the table sizes between the Netezza and IIAS.  On IIAS use the `db_size` script to get tables size information.
[NZ Table sizes](Labs/MigrationTooling/images/BDI_DBSize.md)

[Sample migration script](Labs/MigrationTooling/images/migrate.sh)
...
Single table migration [migrate-table script](Labs/MigrationTooling/images/migrate-table.sh) example.

If you want a peak at the answers, try this page. [Answer sheet](Labs/MigrationTooling/images/Answers.md )
...
* [Netezza Source DML](Labs/MigrationTooling/images/NZQueries/nzbdinsights.sql)
